...
config.widget_bg_color = "#303030"
config.widget_shape = gears.shape.rectangle
config.widget_margins = 5
...
local function worker(user_args)
    ...
    -- Criar os widgets individuais primeiro
    ...
    -- Container com margens internas
    local margin_container = wibox.widget {
        horizontal_layout,
        margins = _config.widget_margins,
    ...
    pacman_widget = wibox.widget {
        margin_container,
        bg = _config.widget_bg_color,
        shape = _config.widget_shape,
        widget = wibox.container.background,
    }

    -- Função para atualizar o widget
    function pacman_widget.set(new_value)
        text_widget:set_text(new_value)
